        ...
        if (imdbId == null || imdbId == "") {
            ...
            request('http://www.imdb.com/title/' + imdbId + '/', function (error, response, body) {
                if (!error && response.statusCode == 200) {
                    ...
                    result.year = $('#titleYear > a').text().trim() || "N/A";
                    ...
                    result.duration = $('#titleDetails time[itemprop="duration"]').text().trim() || "N/A";
                    result.genre = [];
                    ...
                    result.storyLine = $('#titleStoryLine > div[itemprop="description"]').text().trim() || "N/A";
                    result.budget = $('#titleDetails div:contains("Budget:")').length>0?$('#titleDetails div:contains("Budget:")').text().trim().split(':')[1].replace(/(\r\n|\n|\r)/gm, "").replace(/ +(?= )/g, '').trim():"N/A";
                    ...
                    $('#title_recs div.rec_overviews div.rec_overview').each(function () {
                        var movie = {};
